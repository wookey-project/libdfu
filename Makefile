...
frama-c-parsing:
	frama-c framac/entrypoint.c dfu*.c $(LIBUSB_DIR)/usbctrl.c \
		 -c11 \
		 -no-frama-c-stdlib \
		 -cpp-extra-args="-nostdinc -I framac/include -I $(LIBUSB_DIR)/api -I $(LIBUSB_DIR) -I $(LIBSTD_API_DIR) -I $(EWOK_API_DIR) -I $(USBOTGHS_DIR) -I $(USBOTGHS_DEVHEADER_PATH)"

frama-c-eva:
	frama-c framac/entrypoint.c dfu*.c $(LIBUSB_DIR)/usbctrl.c -c11 \
		    $(FRAMAC_GEN_FLAGS) \
			$(FRAMAC_EVA_FLAGS) \
			-save $(EVA_SESSION)
...
frama-c-instantiate:
	frama-c framac/entrypoint.c dfu*.c $(LIBUSB_DIR)/usbctrl.c -c11 -machdep x86_32 \
			$(FRAMAC_GEN_FLAGS) \
			-instantiate
