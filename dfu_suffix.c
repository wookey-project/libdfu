...
int parse_dfu_suffix(dfu_suffix_t dfu_suffix, 	uint8_t *firmware)
{
	...
	dfu_suffix->dwCRC = 0;
	dfu_suffix->suffixlen = 0;
	dfu_suffix->bcdDFU = 0;
	dfu_suffix->idVendor = 0xffff;
	...
	dfu_suffix->idVendor  = (firmware[5] << 8) + firmware[4];
	dfu_suffix->idProduct = (firmware[3] << 8) + firmware[2];
	dfu_suffix->bcdDevice = (firmware[1] << 8) + firmware[0];
