...
.. caution::
   The DFU protocol is not responsible for the firmware image security (integrity, authenticity and so on)

The DFU protocol is based on a relatively big state automaton defined in the `USB DFU class description <http://www.usb.org/developers/docs/devclass_docs/DFU_1.1.pdf>`_
